 ...
 * @package Parse
 */
Yii::import('parse.ParseUser');
Yii::import('parse.ParseObject');
Yii::import('parse.ParseSession');
Yii::import('parse.ParseException');
Yii::import('parse.Internal.Encodable');
Yii::import('parse.HttpClients.ParseCurlHttpClient');
Yii::import('parse.HttpClients.ParseCurl');
