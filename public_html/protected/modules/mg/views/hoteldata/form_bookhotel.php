<form method="post" name="getcancelpolicy-form" action="<?php echo Yii::app()->baseUrl; ?>/index.php?r=mg/hoteldata/BookHotel">
      ...
      <input type="text" name="price" placeholder="1"><br>
